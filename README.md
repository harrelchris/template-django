...
Preconfigured template repository for Django web applications.

![CI](https://github.com/harrelchris/template-django/actions/workflows/ci.yml/badge.svg)
![MIT](https://img.shields.io/github/license/harrelchris/template-django)
...
1. [Click here](https://github.com/harrelchris/template-django/archive/refs/heads/main.zip) to download the zip into the directory
1. Unzip the zipped archive
1. Delete the zipped archive

#### Template

1. [Click here](https://github.com/harrelchris/template-django/generate) to create a repository using this template
